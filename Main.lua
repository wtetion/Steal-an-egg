-- ══════════════════════════════════════════════════════════════════════════════
-- AXEL HUB — Universal ScriptLoader (free)
...
local GAME_NAMES = {
    ...
    [107778070777162]  = "Axel Hub | Steal an Egg",
...
local AXEL_CACHE = _G.AxelLoaderCache or {}
_G.AxelLoaderCache = AXEL_CACHE

local function cacheGet(key)
    local entry = AXEL_CACHE[key]
...
local function cacheSet(key, value)
    AXEL_CACHE[key] = { at = os.clock(), value = value }
end
...
local GAME_MAP = {
    ...
    [107778070777162]  = "Axel_Hub_StealAnEgg.luau",  -- Axel Hub | Steal an Egg 🥚
